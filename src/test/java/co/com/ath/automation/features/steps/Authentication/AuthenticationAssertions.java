...
public class AuthenticationAssertions {
    ...
    public static void shouldSeeSuccessfulStatusCodeVillas() {
      // assertThat(SerenityRest.then().extract().body().jsonPath().get("MsgRsHdr.Status.StatusCode"), equalTo(0));
        assertThat(SerenityRest.then().extract().body().jsonPath().get("bankInfo.BankId"), equalTo(10524));
    }

    public static void shouldSeeSuccessfulStatusCodePopular() {
      //  assertThat(SerenityRest.then().extract().body().jsonPath().get("MsgRsHdr.Status.StatusCode"), equalTo(0));
        assertThat(SerenityRest.then().extract().body().jsonPath().get("bankInfo.BankId"), equalTo(10029));
    }

    public static void shouldSeeSuccessfulStatusCodeOccidente() {
     //   assertThat(SerenityRest.then().extract().body().jsonPath().get("MsgRsHdr.Status.StatusCode"), equalTo(0));
        assertThat(SerenityRest.then().extract().body().jsonPath().get("bankInfo.BankId"), equalTo(10236));
    }
    ...
    public static void aceptadacifin() {
        //   assertThat(SerenityRest.then().extract().body().jsonPath().get("MsgRsHdr.Status.StatusCode"), equalTo(0));
        assertThat(SerenityRest.then().extract().body().jsonPath().get("bankInfo.BankId"), equalTo(10999));
    }
